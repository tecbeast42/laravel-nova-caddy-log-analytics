...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return axios.get('/nova-vendor/caddy-analytics/log');

            case 2:
              _this.logs = _context.sent.data;
              chartist__WEBPACK_IMPORTED_MODULE_1___default().Bar('.status-code-chart', _this.statusCodes);
              chartist__WEBPACK_IMPORTED_MODULE_1___default().Bar('.views-chart', _this.views);
  ...
  methods: {
    extractLogs: function extractLogs(callback) {
      var prepared = this.logs.reduce(callback, {});
      return {
  ...
  computed: {
    views: function views() {
      return this.extractLogs(function (accumulator, log) {
        var _log$resp_headers$Con, _log$resp_headers$Con2, _accumulator$log$requ;

        if (log.status === 200 && !((_log$resp_headers$Con = log.resp_headers["Content-Type"]) !== null && _log$resp_headers$Con !== void 0 && (_log$resp_headers$Con2 = _log$resp_headers$Con[0]) !== null && _log$resp_headers$Con2 !== void 0 && _log$resp_headers$Con2.includes("text/html")) || log.request.uri.includes('/healthcheck') || log.request.uri.includes('/nova') || log.request.uri.includes('/admin')) {
          return accumulator;
        }

        accumulator[log.request.uri] = ((_accumulator$log$requ = accumulator[log.request.uri]) !== null && _accumulator$log$requ !== void 0 ? _accumulator$log$requ : 0) + 1;
        return accumulator;
      });
    },
    statusCodes: function statusCodes() {
      return this.extractLogs(function (accumulator, log) {
        var _accumulator$log$stat;

        accumulator[log.status] = ((_accumulator$log$stat = accumulator[log.status]) !== null && _accumulator$log$stat !== void 0 ? _accumulator$log$stat : 0) + 1;
        return accumulator;
      });
    }
  }
  ...
  return _c("div", { staticClass: "flex flex-col" }, [
    _c("div", { staticClass: "w-full flex flex-col" }, [
      _c(
        "div",
        [
          _c("heading", { attrs: { level: "2" } }, [_vm._v("Views")]),
          _vm._v(" "),
          _c("card", { staticClass: "mb-8" }, [
            _c("div", { staticClass: "views-chart" }),
          ]),
        ],
        1
      ),
      ...
      _c(
        "div",
        [
          _c("heading", { attrs: { level: "2" } }, [_vm._v("Status Codes")]),
          _vm._v(" "),
          _c("card", [_c("div", { staticClass: "status-code-chart" })]),
        ],
        1
      ),
    ]),
